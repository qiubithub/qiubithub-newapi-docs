...
::: tip 接口地址
Gemini CLI 用 `GOOGLE_GEMINI_BASE_URL=https://www.qiubithub.com/gemini_cli`，不要加 `/v1`。
:::
...
GOOGLE_GEMINI_BASE_URL=https://www.qiubithub.com/gemini_cli
...
- `GOOGLE_GEMINI_BASE_URL` 是否保持为 `https://www.qiubithub.com/gemini_cli`
